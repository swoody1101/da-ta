...
const ChatBoxGroup = ({ handleModalA, handleModalB, todayQuestion, ...props }) => {
	const isLogin = useRecoilValue(loginState);

	const handlerClickModalA = () => {
		return isLogin ? handleModalA() : { ...popWarningAlert("", "로그인 후 이용해주세요.") };
	};

	const handlerClickModalB = () => {
		return isLogin ? handleModalB() : { ...popWarningAlert("", "로그인 후 이용해주세요.") };
	};

...
import { letterState, readingLetterIdState, reportModalState } from "../../recoil/Atoms";
...
import { faTriangleExclamation, faShare, faEnvelopeOpenText, faTrashCan, faPaperPlane } from "@fortawesome/free-solid-svg-icons";
		...
		<ButtonDiv>
			{
				[
					...
					>
						<FontAwesomeIcon icon={faPaperPlane} size="lg" style={{ margin: "0 5px 0 0" }} />
						답장하기
					</Button>,
					<Button
						width={"120px"}
					...
					>
						<FontAwesomeIcon icon={faEnvelopeOpenText} size="lg" style={{ margin: "0 5px 0 0" }} />
						보관하기
					</Button>,
					<Button
						width={"120px"}
					...
					>
						<FontAwesomeIcon icon={faTrashCan} size="lg" style={{ margin: "0 5px 0 0" }} />
						삭제하기
					</Button>,
				][index]
			}
			...
			>
				<FontAwesomeIcon icon={faShare} size="lg" style={{ margin: "0 5px 0 0" }} />
				다시 띄우기
			</Button>
			<ReportButton
				width={"120px"}
			...
			>
				<FontAwesomeIcon icon={faTriangleExclamation} size="lg" style={{ margin: "0 5px 0 0" }} />
				신고하기
			</ReportButton>
		</ButtonDiv>
	);

...
const ReportModalContent = () => {
  return (
    <ReportModal>
      ...
      <ReportModalMobileText>해당하는 내용을 체크해주세요</ReportModalMobileText>
      ...
      <hr/>
      <ReportModalBtnDiv>
        <Button width={'30%'} height={'30px'} color={'black'} fontSize={'18px'} borderRadius={'15px'}>신고하기</Button>
        <Button width={'30%'} height={'30px'} color={'black'} fontSize={'18px'} borderRadius={'15px'}>취소하기</Button>
      </ReportModalBtnDiv>
    </ReportModal>
  );
};

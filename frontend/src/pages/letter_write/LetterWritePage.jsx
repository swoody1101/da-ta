...
const LetterWritePage = () => {
	...
	return (
		<>
			...
			<RowCenterWrapper>
				<ContentBlock margin={SizeTypes.PC_LETTER_MARGIN} mWidth={SizeTypes.MOBILE_LETTER_WIDTH} optionToggle={optionToggle}>
				...
				<ContentBlock mWidth={SizeTypes.MOBILE_LETTER_WIDTH} optionToggle={optionToggle}>
					<Spacer act={act} />
				</ContentBlock>
				<ContentBlock

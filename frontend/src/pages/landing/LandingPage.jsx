		...
		<>
			...
			{modalToggleA && (
				...
				>
					...
					<AnswerBox width="90%" height="33%" margin="1rem 0 0 0">
						<QuestionTextArea
			...
			{modalToggleB && (
				<Modal
					...
					flexDirection={"column"}
				>
					<AnswerBox width="95%" height="66%" margin="1rem 0 0 0">
			...
			{/* 스크롤 내릴 시 나타나는 문구들 */}
			<TextWrapper>
				<MainSmallText margin="15vh 0 0 0" data-aos-duration="500" data-aos="flip-up">
